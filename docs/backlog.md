...
Alertar o usuário quando uma demanda for criada ou encaminhada para o seu setor.
...
Registro de lotações.

#### Histórias de usuário
![Epico](./assets/img/backlog/epics/lotacao.png)

### Épico: Cargo
Registro de cargos.

#### Histórias de usuário
![Epico](./assets/img/backlog/epics/cargo.png)

### Épico: Popular o banco

Popular o banco com demandas antigas que estão salvas em planilhas.

#### Histórias de usuário
![Epico](./assets/img/backlog/epics/popular_banco.png)
